...
AstraVisus is a simple modern plugin that allows players to toggle their nightvision on or off with a simple command. You are also able to enable or disable all the features easily inside the config.yml. All the messages are also fully customizable.
...
| Feature | Description |
| ------- | ----------- |
| Toggle Nightvision | Allows the user to toggle nightvision for themselves,other players. or globally |
...
| Disable Worlds | Disable nightvision from being used in specific worlds  |
...
When it comes to installing the plugin, Simply drop the AstraVisus-[version number].jar into your servers plugin folder and then start your server.
...
I have spent some time setting up a discord server that you are welcome to join at any time. Here you are able to seek help, have a chat, be informed of any updates or announcements and just be apart of a great community. You can join the community or invite your friends to the discord community by using this link: https://discord.gg/rCEcVaybTC
