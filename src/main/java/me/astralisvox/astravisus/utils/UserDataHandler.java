...
public class UserDataHandler {
     ...
     */
    public UserDataHandler(final AstraVisus pluginInstance) {
        this.pluginInstance = pluginInstance;
        userDataFile = pluginInstance.getFileManager().getUserDataFile().getConfig();
    }
     ...
     *
     */
    public void addUserToMap(final UUID playerUUID) {
     ...
     */
    public void saveUserDataToFile(final UUID playerUUID) {
     ...
     */
    public void setEffectStatus(UUID uuid, Object status, String effect) {
     ...
     */
    public Object getEffectStatus(UUID uuid, String effect) {
        if(!getUserDataMap().containsKey(uuid)) {
            addUserToMap(uuid);
        }
